...
class checkRice : AppCompatActivity() {
    ...
    private fun setDB_Edit(id: String, a: String, ida: String,nex:Int,ck2:Int) {
        ...
        if (create_DayS.equals("วันที่") || create_MonthS.equals("เดือน") || create_YearS.equals("ปี")||create_checkRice.equals("ข้าว")) {
            ...
            if (create_ck_water.toInt() >= 7 && create_ck_water.toInt() <= 15 || ck2 == 2){
                ...
                ref.child("/$aa/$ida").setValue(plan).addOnCompleteListener {
                    ...
                    Dle(id,a,create_DayS.toInt(),create_MonthS,create_YearS.toInt(),nex,ida,d)
                }
            }else{
                val i = Intent(this, water_else::class.java)
                i.putExtra(cka,create_ck_water)
                startActivity(i)
            }
        }
    ...
    private fun Dle(id: String, a: String,create_DayS:Int,create_MonthS:String,create_YearS:Int,net:Int,ida: String,d:String) {
        var cout = a.toInt()
        val cout1 = cout+1
        ...
        calculate_Date(id,a,create_DayS,create_MonthS,create_YearS,net,ida,d)
    }
    companion object{
        val dayw ="dayw"
        val monthw = "monthw"
