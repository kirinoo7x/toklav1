...
import kotlinx.android.synthetic.main.activity_lise_fram_user.*
import kotlinx.android.synthetic.main.patien_c_patien.view.*

class LiseFramUser : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lise_fram_user)
        ...
        imageView53.setOnClickListener {
            startActivity(Intent(this,listmultiUser::class.java))
        }
                ...
                p0.children.forEach {
                    ...
                    if (re_plan != null ){
                        ...
                        if (pp != "อยู่ระหว่างดำเนินการ" && pp!="อยู่ระหว่างดำเนิดการ"){
                            adapter.add(planItemuser(re_plan))
                        }
                    }
                }
                adapter.setOnItemClickListener{ item, view ->
                    val ItemPlanUser = item as planItemuser
...
class planItemuser(val re_plan: sentToCreateplan): Item<ViewHolder>(){
