...
import kotlinx.android.synthetic.main.activity_plan.imageView15
...
class L_chemical : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_l_chemical)
        ...
        formula_fertilizer_2.setText(ff2)
        formula_fertilizer_3.setText(ff3)

        fertilizer_1.setText(mf1)
        fertilizer_2.setText(mf2)
        fertilizer_3.setText(mf3)
        ...
        imageView13.setOnClickListener {
            val  intent=Intent(this, L_edit_chemical::class.java)
            ...
            intent.putExtra(Fformula2lf,ff2)
            intent.putExtra(Fformula3lf,ff3)

            intent.putExtra(Mfertilizer1lf,mf1)
            intent.putExtra(Mfertilizer2lf,mf2)
            intent.putExtra(Mfertilizer3lf,mf3)
        ...
        imageView46.setOnClickListener {
            if(Attribute == "นาดำ"){
                ...
                val  intent=Intent(this, Noti_chemical2::class.java)
                intent.putExtra(idfu,idfuu)
                intent.putExtra(namefram,name_Farm)
                intent.putExtra(Framland,aria)
                intent.putExtra(Address,address)
    ...
    companion object{
        ...
        var Fformula2lf = "Fformula2"
        var Fformula3lf = "Fformula3"
        var Mfertilizer1lf = "Mfertilizer1"
        var Mfertilizer2lf = "Mfertilizer2"
        var Mfertilizer3lf = "Mfertilizer3"
        var Fformula = "Fformula"
    }
}
