...
class Calendar_Noti : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_calendar__noti)

        val idf = intent.getStringExtra(Plan.idFram)
            ...
            override fun onDataChange(p0: DataSnapshot) {
                p0.children
                    .forEach {
                        ...
                        mm18.setText(m)
                        yy18.setText(y)
                        val intro = "20.ปล่อยน้ำออกจากคันนา"
                        val id1 = id
                        if(s == "no"){
                            status18.setText(ss)
                        }else{
    ...
    private fun toA_no_completed(idf: String,name_f:String,address_f:String,Aty:String,introo:String,intro_o: String,ida:String,netx:String,cout:String) {
        ...
        var mf2 = intent.getStringExtra(Plan.Mfertilizer1)
        var mf3 = intent.getStringExtra(Plan.Mfertilizer1)
        ...
        intent.putExtra(areafram,areaf)
        ...
        intent.putExtra(Rice_quantityf,riceq)
        intent.putExtra(Fformula1,ff1)
        intent.putExtra(Fformula2,ff2)
        intent.putExtra(Fformula3,ff3)
        intent.putExtra(Mfertilizer1,mf1)
        intent.putExtra(Mfertilizer2,mf2)
        intent.putExtra(Mfertilizer3,mf3)
        startActivity(intent)
    }
