...
import com.tiwlynaja.admin.konklav1.Noti_check_do.AlarmReceiver
import com.tiwlynaja.admin.konklav1.R
import java.util.*

class NotificationService_CKW : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0 ) {
            ...
            val notifyIntent = Intent(this, ResultActivity_CKW::class.java)
